...
exports.modalTemplate = exports.getImageDataURI = exports.open = exports.close = exports.chasquiSend = exports.send = undefined;
...
var _chasqui = require('./../chasqui.js');
...
var send = function send(appName) {
  return function (uri) {
    var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
        cancel = _ref.cancel,
        introModal = _ref.introModal;

    uri = /type=/.test(uri) ? uri : (0, _util.paramsToQueryString)(uri, { type: 'post' });
...
var chasquiSend = function chasquiSend() {
  var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      chasquiUrl = _ref2$chasquiUrl === undefined ? CHASQUI_URL : _ref2$chasquiUrl,
  ...
  return function (uri) {
    return transport(uri).then(function (res) {
      close();
      return res;
    }, function (err) {
      close();
 ...
 */
var open = function open(data, cancel, appName, introModal) {

  var wrapper = document.createElement('div');
  wrapper.setAttribute('id', 'uport-wrapper');

  wrapper.innerHTML = introModal ? introModalTemplate(appName) : modalTemplate({ qrImageUri: getImageDataURI(data), cancel: cancel });
  ...
  var uportTransition = function uportTransition(event) {
    wrapper.innerHTML = modalTemplate({ qrImageUri: getImageDataURI(data), cancel: cancel });
 ...
 */
var introModalTemplate = function introModalTemplate(appName) {
 ...
 */
var modalTemplate = function modalTemplate(_ref3) {
  var qrImageUri = _ref3.qrImageUri;

...
exports.clearResponse = exports.poll = exports.URIHandlerSend = undefined;
...
var URIHandlerSend = function URIHandlerSend(uriHandler) {
  ...
  return function (uri) {
    ...
    var cb = chasquiUrl + (0, _index.randomString)(16);
    uri = (0, _util.paramsToQueryString)(uri, { 'callback_url': cb, 'type': 'post' });
